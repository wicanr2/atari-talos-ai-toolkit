...
| M2 | ST／STF 記憶體、TOS 開機與決定性時鐘 | **基礎 memory map、power-on reset、MMU、exception、`RESET`、空 cartridge、line-F、ST void I/O、`TST.B` bus error 與首個 external bus slot 切片已 CONFORMED；固定 EmuTOS 可走 7,474 條，下一停點為 `$FFFA01` MFP byte write** |
