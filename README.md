...
| M1 | 68000 核心通過公開指令語料與邊界測試 | **基礎／控制流／control EA、完整 MOVE／MOVEA／MOVEM／LINK／UNLK／ADDA／AND／ANDI／OR／ORI／CMP／CMPI／CMPM／ADD／ADDI／ADDQ／SUB／SUBI／SUBQ／CLR／TST／ASL／ASR／LSR／MULS／MULU／NOT／NEG／Scc／DBcc，共 157,500 筆外部語料已通過** |
