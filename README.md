...
| M2 | ST／STF 記憶體、TOS 開機與決定性時鐘 | **基礎 memory map、power-on reset、MMU `$FF8001` 與 EmuTOS 前 7 條指令已對 Hatari CONFORMED；現停在 MC68000 illegal-instruction vector 4，其餘 I/O 與後續 TOS 開機進行中** |
