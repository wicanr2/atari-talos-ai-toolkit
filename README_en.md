...
passes 230,000 external corpus cases, and the incremental ST/STF machine core executes 7,515
instructions of a fixed EmuTOS 1.3 ROM in parity with Hatari. The next explicit stop is the
unsupported MFP Vector Register byte write at `$FFFA17`. Video, input, disk, and a complete TOS boot are not
