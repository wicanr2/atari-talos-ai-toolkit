...
| TOS 開機 | reset、MMU、exceptions、`RESET`、VBL、Shifter、部分 MFP／PSG／ACIA 已建立；bus arbitration／I/O 待擴充 | Hatari 2.4.1／EmuTOS 1.3 同 ROM | 進行中；正常路徑至136,182 instructions／1,578,882 clocks，下一gate是MFP channel 4／Timer D重設 |
