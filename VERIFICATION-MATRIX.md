...
| TOS 開機 | reset、MMU、exceptions、`RESET`、VBL、Shifter、MFP Timer C/D、部分PSG／ACIA／USART／FDC已建立；bus arbitration／I/O待擴充 | Hatari 2.4.1／EmuTOS 1.3同ROM | 進行中；正常路徑至1,092,926條／14,015,626 clocks完成第三輪IKBD讀時鐘，下一gate是VBL90 `flopvbl()` |
