...
| ST MFP Timer D system-clock start | `$EF` clear、`$51→$50` stop、TDDR=`$00`=256、IERB/IMRB=`$70`、TCDCR=`$52` | MC68901契約；Hatari MFP start/I/O trace；固定EmuTOS ROM | 通過；136,210 instructions／1,579,228 clocks，recurrence／IRQ待補 |
...
| TOS 開機 | reset、MMU、exceptions、`RESET`、VBL、Shifter、部分 MFP／PSG／ACIA 已建立；bus arbitration／I/O 待擴充 | Hatari 2.4.1／EmuTOS 1.3 同 ROM | 進行中；正常路徑至136,210 instructions／1,579,228 clocks，下一缺口是Timer D recurrence／MFP IRQ |
