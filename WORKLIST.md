...
| ST／STF I/O memory map | 進行中 | recurring VBL、video mode、palette、programmed／active base、low-res planar、MFP boot init、PSG與兩組ACIA init已接；下一步是Timer D recurrence／channel 4 IRQ，之後接Timer C timeout／IRQ |
