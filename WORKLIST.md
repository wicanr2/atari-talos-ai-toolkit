...
| ST／STF I/O memory map | 進行中 | recurring VBL、video mode、palette、programmed／active base、low-res planar、MFP boot init、PSG與兩組ACIA init已接；下一gate是MFP channel 4／Timer D重設，之後接Timer C timeout／IRQ |
