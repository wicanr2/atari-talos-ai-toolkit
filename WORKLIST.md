...
| ST／STF I/O memory map | 進行中 | recurring VBL、video mode、palette、programmed／active base、low-res planar、MFP boot init、Timer C/D IRQ、PSG與兩組ACIA init已接；續跑找下一個typed gate |
