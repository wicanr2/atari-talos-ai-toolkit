...
| ST raw `.st` 軟碟映像輸入（規格 141） | **CONFORMED** | boot-sector BPB 自證 geometry、精確長度、1-based sector CHS、不可變掛載、invalid replacement 原子失敗與 cold reset 保留均有測試；下一步接 WD1772 成功讀取與 DMA |
