...
| ST WD1772 唯讀 sector DMA（規格 142） | **CONFORMED** | drive A／side 0／track 0／sector 1 經固定可重現期限搬入 512-byte RAM；DMA address/count、`DMA_OK`、Type-II `$80`、IRQ/GPIP5 與 dummy seek 正常路徑由固定 EmuTOS 從 reset 驗收。下一步擴充連續 sector 與一般 CHS |
